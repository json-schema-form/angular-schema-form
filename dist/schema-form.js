                ...
                function ($parse, $compile, $http, $templateCache, scrollingTop, $timeout, $filter) {
                    ...
                    return {
                        ...
                        link: function (scope, element, attrs, sfSchema) {
                            ...
                            scope.updateModelForInputFile = function(filename) {
                                //вызвать action формы (соответвующий полю)

                                //angular.element(this).scope().form.onChange(this.value);

                                scope.$apply(function () {
                                    scope.form.filename = filename.replace("C:\\fakepath\\", "");
                                });
                            };
