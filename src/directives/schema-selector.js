/**
 * Directive that handles a choice of schemas
 */
angular.module('schemaForm').directive('sfSchemaSelector', ['sfSelect', 'schemaForm', 'sfValidator', 'sfPath',
  function(sfSelect, schemaForm, sfValidator, sfPath) {
    ...
    return {
      ...
      link: function(scope, element, attrs, ngModel) {
        ...
        scope.validateSchemaSelector = angular.noop;
        ...
        var once = scope.$watch(attrs.sfArray, function(form) {
          ...
          if (ngModel) {
            ...
            scope.validateSchemaSelector = function() {
            ...
            scope.$on('schemaFormValidate', scope.validateSchemaSelector);
